...
The project combines Data Science, Machine Learning, and Business Intelligence to deliver executive-level workforce insights and predictive analytics.
...
│
├── powerbi/
│   └── Enterprise_AI_Workforce_Intelligence.pbix
│
├── screenshots/
│   └── dashboard_preview.png
│
├── src/
│   └── ai_worker_burnout_attrition.py
│
├── requirements.txt
├── README.md
└── .gitignore
